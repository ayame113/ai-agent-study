...
| 日付 | 内容 |
|---|---|
| 12/3 | AIエージェントとmcpについての説明<br>claude desktopのインストールとmcpの利用 |
| 12/10 | 13:00〜 discordへのinvite作業／作成したいAIエージェントの案を出す<br>15:00〜 mcpサーバーを自作してclaude desktopから呼び出す |
| 12/17 | 13:00〜 前回の続き<br>15:00〜 OpenAIのAPIをPythonから呼び出す／パラメータ調整 |
| 12/24 | 前回の続き |
| 1/7 | 13:00〜 前回の続き<br>15:00〜 AIエージェントをdiscordと接続+スライド作り |
| 1/14 | AIエージェントをdiscordと接続+スライド作り |
| 1/21 | 発表+他の人の作品を触る |
